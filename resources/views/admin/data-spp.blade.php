									...
									<div class="container px-2">
										<nav aria-label="breadcrumb">
											<ol class="breadcrumb mb-0">
												...
												<li class="breadcrumb-item by-text-label active" aria-current="page">Data SPP</li>
											</ol>
										</nav>
										<div class="row">
											<div class="col-lg-6">
											...
											<div class="col-lg-6">
												<div class="text-right mt-4 mr-3">
													<a href="{{url('admin/data-spp/tambah')}}" class="btn btn-primary btn-sm rounded-pill px-3">+ Tambah SPP</a>
												</div>
											</div>
										</div>
									</div>
									<table class="table table-borderless mx-1">
										...
										<tr>
											...
											<form action="{{url('admin/delete/spp'.$row->id_spp)}}" method="post">
													<a class="btn btn-link px-0" href="{{url('admin/data-spp/edit/'.$row->id_spp)}}">
