										...
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="text-right mt-4 mr-3">
													<a href="{{url('admin/data-pembayaran/tambah')}}" class="btn btn-primary btn-sm rounded-pill px-3">+ Tambah Pembayaran</a>
												</div>
											</div>
										</div>
									</div>
										...
										<tr>
											...
											<td>
												<form action="{{url('admin/delete/pembayaran'.$row->id_pembayaran)}}" method="post">
													<a class="btn btn-link px-0" href="{{url('admin/data-pembayaran/edit/'.$row->id_pembayaran)}}">
