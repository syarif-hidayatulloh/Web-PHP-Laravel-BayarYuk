					...
					<div class="row">
						<div class="col-lg-2 mb-3">
							<div class="list-group by-text-body">
								<a class="list-group-item list-group-item-action active" href="{{url('petugas/home')}}">Pembayaran</a>
							</div>
						</div>
						<div class="col-lg-10">
							<div class="card">
									...
									<div class="container px-2">
										<nav aria-label="breadcrumb">
											<ol class="breadcrumb mb-0">
												<li class="breadcrumb-item by-text-label">Petugas</li>
												<li class="breadcrumb-item by-text-label">Data Pembayaran</li>
												<li class="breadcrumb-item by-text-label" aria-current="page">Pembayaran</li>
											</ol>
										</nav>
										<div class="row">
											<div class="col-lg-12">
										...
										<form action="{{url('petugas/pembayaran',@$pembayaran->id_pembayaran)}}" method="post">
											...
											<div class="form-group">
												...
												<select class="form-control" name="bulan_bayar" id="bulan_bayar">
													<option value="">Pilih Bulan Bayar</option>
														...
														<option value="febuari" {{old('bulan_bayar',(@$pembayaran->bulan_bayar == 'febuari')? 'selected' : '')}}>Febuari</option>
											...
											<button class="btn btn-primary w-75" type="submit">Kirim</button>
										</form>
									</div>
								</div>
							</div>
